    ...
    <div>
        ...
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="my-0">Datos de la Empresas</h3>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="my-0"><S></S>ql Server</h3>
            </div>
            <div class="card-body">
                <form autocomplete="off"
                      @submit.prevent="submit">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_driver}"
                                     class="form-group">
                                    <label class="control-label">Driver</label>
                                    <el-input v-model="form.server_driver"
                                              ></el-input>
                                    <small v-if="errors.server_driver"
                                           class="form-control-feedback"
                                           v-text="errors.server_driver[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_url}"
                                     class="form-group">
                                    <label class="control-label">Url</label>
                                    <el-input v-model="form.server_url"
                                              ></el-input>
                                    <small v-if="errors.server_url"
                                           class="form-control-feedback"
                                           v-text="errors.server_url[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_host}"
                                     class="form-group">
                                    <label class="control-label">Host</label>
                                    <el-input v-model="form.server_host"
                                              ></el-input>
                                    <small v-if="errors.server_host"
                                           class="form-control-feedback"
                                           v-text="errors.server_host[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_port}"
                                     class="form-group">
                                    <label class="control-label">Port</label>
                                    <el-input v-model="form.server_port"
                                              ></el-input>
                                    <small v-if="errors.server_port"
                                           class="form-control-feedback"
                                           v-text="errors.server_port[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_database}"
                                     class="form-group">
                                    <label class="control-label">Database</label>
                                    <el-input v-model="form.server_database"
                                              ></el-input>
                                    <small v-if="errors.server_database"
                                           class="form-control-feedback"
                                           v-text="errors.server_database[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_username}"
                                     class="form-group">
                                    <label class="control-label">Username</label>
                                    <el-input v-model="form.server_username"
                                              ></el-input>
                                    <small v-if="errors.server_username"
                                           class="form-control-feedback"
                                           v-text="errors.server_username[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_password}"
                                     class="form-group">
                                    <label class="control-label">Password</label>
                                    <el-input v-model="form.server_password"
                                              ></el-input>
                                    <small v-if="errors.server_password"
                                           class="form-control-feedback"
                                           v-text="errors.server_password[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_charset}"
                                     class="form-group">
                                    <label class="control-label">Charset</label>
                                    <el-input v-model="form.server_charset"
                                              ></el-input>
                                    <small v-if="errors.server_charset"
                                           class="form-control-feedback"
                                           v-text="errors.server_charset[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_prefix}"
                                     class="form-group">
                                    <label class="control-label">Prefix</label>
                                    <el-input v-model="form.server_prefix"
                                              ></el-input>
                                    <small v-if="errors.server_prefix"
                                           class="form-control-feedback"
                                           v-text="errors.server_prefix[0]"></small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div :class="{'has-danger': errors.server_prefix_indexes}"
                                     class="form-group">
                                    <label class="control-label">Prefix Indexes</label>
                                    <el-input v-model="form.server_prefix_indexes"
                                              ></el-input>
                                    <small v-if="errors.server_prefix_indexes"
                                           class="form-control-feedback"
                                           v-text="errors.server_prefix_indexes[0]"></small>
                                </div>
                            </div>
