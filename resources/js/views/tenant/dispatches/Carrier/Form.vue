                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div :class="{'has-danger': errors.address}"
                                ...
                                <el-input v-model="form.sender_address_data.address"></el-input>
                        ...
                        <div class="col-md-6">
                            <div :class="{'has-danger': errors.location_id}"
                                ...
                                <el-cascader v-model="form.sender_address_data.location_id"
                                            :options="locations"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div :class="{'has-danger': errors.location_id}"
                                class="form-group">
                                <label class="control-label">Ubigeo</label>
                                <el-cascader v-model="form.receiver_address_data.location_id"
                                            :options="locations"
                                            filterable></el-cascader>
                                <small v-if="errors.location_id"
                                    class="form-control-feedback"
                        ...
                        <div class="col-md-6">
                            <div :class="{'has-danger': errors.address}"
                                class="form-group">
                                <label class="control-label">Dirección</label>
                                <el-input v-model="form.receiver_address_data.address"></el-input>
                                <small v-if="errors.address"
                                    class="form-control-feedback"
                                    v-text="errors.address[0]"></small>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr v-for="(row, index) in form.items">
                                    ...
                                    <td class="text-right">{{ row.second_name }}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <div :class="{'has-danger': errors.second_name}"
                                                    ...
                                                    <el-input
                                                        v-model="second_name"
                                                        placeholder="Observación"></el-input>
                                            ...
                                            <div class="col-2">
                                                <div :class="{'has-danger': errors.unit_price}"
                                                    ...
                                                    <el-input
                                                        v-model="unit_price"
                                                        placeholder="Precio Unitario"></el-input>
    ...
    methods: {
        ...
        addAItemInRow() {
            ...
            if(this.unit_price == null){
                this.$set(this.errors, 'unit_price', ['Digite el precio unitario']);
            }
        ...
        onLoadItemsFromSummary(items, itemsFromStorage) {
            items.map(it => {
                ...
                const unit_by_items = _.sumBy(itemsFromStorage.filter(i => i.id == it.id), function (row) {
                    return parseFloat(row.unit_price)
                })
                const second_nameByItems = _.sumBy(itemsFromStorage.filter(i => i.id == it.id), function (row) {
                    return row.second_name
                })
                if (quantityByItems) {
                    this.addItem({
                        item: it,
                        quantity: quantityByItems,
                        unit_price : unit_by_items,
                        second_name : second_nameByItems
                    });
                }
            });
